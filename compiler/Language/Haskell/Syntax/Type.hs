...
module Language.Haskell.Syntax.Type (
        ...
        HsArrow, HsArrowOf, HsMultAnnOn(..), OnArrow, OnRecField, HsUnannotatedMult(..),
...
pattern HsUnrestrictedArrow :: XUnannotated OnArrow mult pass -> HsArrowOf mult pass
...
type family XUnannotated  on mult p
type family XLinearAnn    on mult p
type family XExplicitMult on mult p
type family XXMultAnnOn   on mult p
